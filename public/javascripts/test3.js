...
var places=new Array("London", "New York","Beijing","Tokyo","Seoul","Seattle","Los Angeles","Pairs","Shanghai","Hong Kong","Vancouver");
var info = new Array(
"London is the capital and most populous city of England and the United Kingdom. ",
"New York—often called New York City or the City of New York to distinguish it from the State of New York, of which it is a part—is the most populous city in the United States and the center of the New York metropolitan area, the premier gateway for legal immigration to the United States.",
...
"Seoul – officially the Seoul Special City – is the capital and largest metropolis of South Korea, forming the heart of the Seoul Capital Area.",
"Seattle is a West Coast seaport city and the seat of King County. ",
"L.A., is the second-largest city in the United States after New York City, the most populous city in the U.S. state of California, and the county seat of Los Angeles County.",
"Paris s the capital and most populous city of France.",
"Shanghai is the largest Chinese city by population[9][10] and the 2nd largest city proper by population in the world.",
...
function createWaterfell() {
      $("#div1").waterfall({
          ...
          ajaxCallback: function(success, end) {
              ...
              url = "http://www.panoramio.com/map/get_panoramas.php?set=public&from=0&to=5&minx="+minx+"&miny="+miny+"&maxx="+maxx+"&maxy="+maxy+"&size=medium&mapfilter=true&callback=?"
              console.log(url);
              ...
              */
              ...
              for(var j = 0; j<6;j++)
              {
                ...
                if(pic[j]!= null){
                  ...
                  t = "Shanghai";
                  intro = "Shanghai is the largest Chinese city by population and the 2nd largest city proper by population in the world.";
                }
              ...
              str += temp_6;
              str += temp_7.replace("{{introduction}}", intro);
              str += temp_8;
              $(str).appendTo($("#div1"));
              }
