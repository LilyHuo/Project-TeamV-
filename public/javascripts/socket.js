...
function clearCluster() {
    // if (selectedWord == "the") {
    //     markerCluster = new MarkerClusterer(null, theMarkers);
    // } else if (selectedWord == "sport") {
    //     markerCluster = new MarkerClusterer(null, sportMarkers);
    // } else if (selectedWord == "music") {
    //     markerCluster = new MarkerClusterer(null, musicMarkers);
    // } else if (selectedWord == "food") {
    //     markerCluster = new MarkerClusterer(null, foodMarkers);
    // } else if (selectedWord == "game") {
    //     markerCluster = new MarkerClusterer(null, gameMarkers);
    // }
