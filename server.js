...
var cd = mysql.createConnection( {
	host: 'twittermap.cw9aoj0f5wl9.us-east-1.rds.amazonaws.com',
	user: 'ruilu',
	password: '19921119',
	port : '3306',
	database : 'twittermap'
...
var sqs = require("sqs");
var queue = sqs({
	access: 'AKIAJ2ZUSXDVSC2NMQTQ',
	secret: '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',
	region: 'us-east-1'
})
...
var auth = {
    region: 'us-east-1',
  	account: '363635349051',
    topic: 'tweetsSentiment'
};
...
if(cluster.isMaster) {
	...
	var twitInfo = new twitter({
		consumer_key: 'FWfJJbJn9bwohidDgQqfvwbix',
		consumer_secret: 'Qv7ncOqap9m4FtGibB0YuHvAM861cSxnO9VoERpgMD4iIjV9fK',
		access_token_key: '3941167030-rtx1m28p8fVV1MTUtZyJnK10YoEXMjGM9hUHgoW',
		access_token_secret: 'ipzjtJAM8XbibWMGR6xGCQwxJUCBERTiFNj5sfNBzTHYE'
	});
	...
	var T = new Twit({
		consumer_key: 'FWfJJbJn9bwohidDgQqfvwbix',
	  	consumer_secret: 'Qv7ncOqap9m4FtGibB0YuHvAM861cSxnO9VoERpgMD4iIjV9fK',
	  	access_token: '3941167030-rtx1m28p8fVV1MTUtZyJnK10YoEXMjGM9hUHgoW',
	  	access_token_secret: 'ipzjtJAM8XbibWMGR6xGCQwxJUCBERTiFNj5sfNBzTHYE'
	});
	...
	var alchemy = new AlchemyAPI('5162766487807272dccbe0f26ac149147e518783');
	var mymood;
